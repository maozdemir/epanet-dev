...
The EPANET 3 shared library contains an API that allows one to write custom applications by making function calls to it. A small example application can be found [here (Differences from EPANET2.md)](https://github.com/OpenWaterAnalytics/epanet-dev/blob/develop/doc/Differences%20From%20EPANET2.md).
